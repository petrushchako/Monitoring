...
Set `targetCompatibility` to `JavaVersion.VERSION_1_8` for Java 8 or `JavaVersion.VERSION_11` for Java 11.
...
Set the version to `11.+` for Java 11 or delete the whole line for Java 8.
