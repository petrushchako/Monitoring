...
In your "Training-<Month>-0XX" environment on the [training-cluster](https://dev.eu10.apm.services.cloud.sap/login) select the "Applications & Microservices" -> "Services" tab in your Environment and click on the service "Requests to public networks".
...
3. Go back to Dynatrace and check in the "Application Observability" -> "Services" tab that you see two additional new services (might take a minute or two until they show up).
