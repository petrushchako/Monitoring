...
3. Open your "Training-<Month>-0XX" environment on the [training-cluster](https://dev.eu10.apm.services.cloud.sap/login).
...
11. Open the "Application Observability" -> "Services" tab and check that you can see your newly defined service (this might take up to 3 minutes).
