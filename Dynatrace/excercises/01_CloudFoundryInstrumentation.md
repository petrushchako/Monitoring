...
Open the "Application Observability" -> "Services" tab in Dynatrace and check if you see a service called "AlbumController" (it might take two minutes for the service to show up). 
